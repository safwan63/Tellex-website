      ...
      <section className="py-12 sm:py-16 md:py-20 bg-tellex-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <h3
              className="text-xl sm:text-2xl font-semibold text-tellex-dark-green mt-6 sm:mt-8 mb-3 sm:mb-4"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
            ...
            <ul className="list-disc list-inside text-tellex-black/80 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6 space-y-3 ml-4">
            ...
            <p className="text-tellex-black/80 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" className="text-tellex-dark-green hover:underline" target="_blank" rel="noopener noreferrer">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
            </p>
            <p className="text-tellex-black/80 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="min-w-full border border-tellex-black/20">
                <thead className="bg-tellex-dark-green text-tellex-white">
                  <tr>
                    <th className="px-4 py-3 text-left">Category</th>
                    <th className="px-4 py-3 text-left">Categories of Recipients</th>
                  </tr>
                </thead>
                <tbody className="bg-tellex-white">
                  <tr className="border-t border-tellex-black/20">
                    <td className="px-4 py-3">Identifiers such as basic contact details and certain order and account information</td>
                    <td className="px-4 py-3">Vendors and third parties who perform services on our behalf (such as Internet service providers, payment processors, fulfillment partners, customer support partners and data analytics providers)</td>
                  </tr>
                  <tr className="border-t border-tellex-black/20">
                    <td className="px-4 py-3">Commercial information such as order information, shopping information and customer support information</td>
                    <td className="px-4 py-3">Business and marketing partners</td>
                  </tr>
                  <tr className="border-t border-tellex-black/20">
                    <td className="px-4 py-3">Internet or other similar network activity, such as Usage Data</td>
                    <td className="px-4 py-3">Affiliates</td>
                  </tr>
                  <tr className="border-t border-tellex-black/20">
                    <td className="px-4 py-3">Geolocation data such as locations determined by an IP address or other technical measures</td>
                    <td className="px-4 py-3">Vendors and third parties who perform services on our behalf</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p className="text-tellex-black/80 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:tellexaiofficial@gmail.com" className="text-tellex-dark-green hover:underline">tellexaiofficial@gmail.com</a> or contact us at BaithulZakwan Parambil Palli Makkam, House , Kozhikode, KL, 673611, IN.
            </p>
          </div>
        </div>
      </section>
